...
class Economia(commands.Cog):
    ...
    @app_commands.describe(
        ...
        cantidad="Cantidad para cada miembro."
    )
    ...
    async def give_role_money(
        ...
        if count == 0:
            ...
            return await interaction.followup.send(
                f"❌ No hay miembros humanos con {rol.mention}."
            )
        ...
        embed = discord.Embed(
            ...
            description=(
                f"Se entregaron **{format_money(cantidad)}** "
                f"a cada miembro con {rol.mention}.\n\n"
    ...
    @app_commands.describe(
        usuario="Usuario al que se le quitará dinero.",
        cantidad="Cantidad de dinero."
    )
    ...
    @app_commands.describe(
        usuario="Usuario cuyo dinero será establecido.",
    ...
    @app_commands.describe(
        usuario="Usuario cuya economía será reiniciada."
    )
    ...
    @app_commands.describe(
        usuario="Usuario cuyo banco recibirá dinero.",
        cantidad="Cantidad de dinero."
    )
    async def add_bank(
        self,
    ...
    @app_commands.describe(
        usuario="Usuario cuyo banco perderá dinero.",
        cantidad="Cantidad de dinero."
    )
    ...
    @app_commands.describe(
        usuario="Usuario cuyo banco será establecido.",
        cantidad="Nueva cantidad."
    )
    async def set_bank(
        self,
